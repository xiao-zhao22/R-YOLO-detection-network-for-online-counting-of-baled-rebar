...
def deal_yolov8p_result(data_path):
...
if __name__ == '__main__':
    epoch = 100
    yolov8_result_csv = r"C:\Users\86183\Desktop\yolov8\ultralytics-main\runs\detect\loss\other\CIOU\results.csv"
    yolov8p_result_csv = r"C:\Users\86183\Desktop\yolov8\ultralytics-main\runs\detect\ASF_P2\results.csv"
    ...
    #yolov8p_result_data = deal_yolov8p_result(yolov8p_result_csv)
    yolov8p_result_data = pd.read_csv(yolov8p_result_csv)
    #yolov8_result_data = pd.read_csv(yolov8_result_csv)
    ...
    plt.plot(np.arange(epoch), yolov8_result_data['       metrics/mAP50(B)'], label='yolov8', linewidth=2)
    plt.plot(np.arange(epoch), yolov8p_result_data['       metrics/mAP50(B)'], label='yolov8p', linewidth=2)
    #plt.plot(np.arange(epoch), np.array(yolov8p_result_data[1:, 6], dtype=float), label='yolov8p', linewidth=2)
